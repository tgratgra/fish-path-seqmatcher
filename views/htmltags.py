...
These are a few dirt-simple functions for generating html, handling the
generation of opening, closing and closed tags with attributes. This is suitable
(and useful) for building up small fragments of HTML. More sophisticated
toolkits and templates should be used for larger problems.
